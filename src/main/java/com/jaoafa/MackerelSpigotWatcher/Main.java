package com.jaoafa.MackerelSpigotWatcher;
...
import com.jaoafa.MackerelSpigotWatcher.Task.Task_SendMetrics;
...
public class Main extends JavaPlugin {
	...
	public void onEnable() {
		...
		String mackerelAPIKey = null;
		String mackerelHostId = null;

		// ---------- Get API KEY ---------- //

		if (conf.contains("apikey") && conf.isString("apikey") && !conf.getString("apikey").equals("null")) {
